    ...
    setBuyText: function(){
          game.data.buytext = new (me.Renderable.extend({
            ...
            draw: function(renderer) {
                ...
                this.font.draw(renderer.getContext(), "Ability W: Eat Your Creep For Health / Current Level: " + game.data.ability2 + " Cost: " + ((game.data.ability2+1)*10), this.pos.x, this.pos.y + 200);
                this.font.draw(renderer.getContext(), "Ability E: Throw Spear / Current Level: " + game.data.ability3 + " Cost: " + ((game.data.ability3+1)*10), this.pos.x, this.pos.y + 240);
            }
        })); 
